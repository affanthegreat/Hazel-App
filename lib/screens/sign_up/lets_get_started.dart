...
class HazelLetsGetStarted extends StatefulWidget {
  const HazelLetsGetStarted({super.key});

  @override
  State<HazelLetsGetStarted> createState() => _HazelLetsGetStartedState();
}

class _HazelLetsGetStartedState extends State<HazelLetsGetStarted> {
